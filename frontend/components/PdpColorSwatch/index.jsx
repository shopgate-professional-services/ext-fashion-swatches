...
// TODO: move to config
const colorCircle = `radial-gradient(circle at 38% 7% ,rgba(255,255,000,1) 20%,rgba(255,255,000,.0) 38%),radial-gradient(circle at 50% 0%,rgba(128,255,000,1) 22%,rgba(128,255,000,.0) 48%),
    ...
    radial-gradient(circle at 93% 75% ,255,000,255,1) 2rgba(000,128,255,1) 22%,rgba(000,128,255,.0) 48%),
    ...
    radial-gradient(circle at 25% 93%,rgba(2%,rgba(255,000,255,.0) 48%),
